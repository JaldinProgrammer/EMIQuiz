        ...
        <div class="container-fluid">
          <div class="navbar-header" style="margin: 5px">
            <a class="navbar-brand" href="/">
              <img src="{{asset('./Icons/quiz.png')}}" alt="store" width="35" height="35" >
              Quizz EMI</a>
          ...
          <div class="collapse navbar-collapse" id="navbarNavDropdown">
            <ul class="navbar-nav">
                ...
                <li class="nav-item fs-6" >
                  <a class="nav-link fs-6" href="{{route('user.login')}}">Login</a>
                </li> 
                <li class="nav-item fs-6" >
                  <a class="nav-link fs-6" href="{{route('user.register')}}">Registrarse</a>
                </li> 
                @endguest
                @auth
                <li class="nav-item fs-6" >
                  <a class="nav-link fs-6" href="{{route('user.perfil')}}">{{Auth::user()->name}}</a>
                </li> 
                <li class="nav-item fs-6" >
                  <a class="nav-link fs-6" href="{{route('quiz.show',Auth::user()->id)}}">{{"Mis cuestionarios"}}</a>
                </li> 
                <li class="nav-item">
